...
Với sự phát triển mạnh mẽ của công nghệ Cloud, sự bùng nổ của big data, và sự nỗ lực không ngừng nghỉ của các nhà nghiên cứu, Machine Learning (ML) đã và đang được ứng dụng rộng rãi ở nhiều ngành nghề khác nhau. Điều này nảy sinh nhu cầu làm sao để tăng hiệu năng, độ tin cậy của các ứng dụng ML, và giảm thiểu thời gian _go-to-market_ của quá trình xây dựng các ứng dụng này.
